...
const TRANSLATIONS = {
  ru: {
    ...
    // Privacy Policy & Terms of Service (Legal & Regulatory Compliance: RU & UK Only)
    nav_privacy: "Конфиденциальность",
    footer_privacy: "Политика конфиденциальности и Условия",
    privacy_badge: "Правовой регламент: Законодательство РФ и Великобритании (RU & UK)",
    privacy_title: "Политика конфиденциальности и Условия использования",
    privacy_sub: "Правила сбора технической телеметрии, защита персональных данных и гарантии соблюдения 152-ФЗ РФ, законодательства Великобритании UK GDPR (Data Protection Act 2018) и правил Google Play & Apple App Store.",
    privacy_sec1_title: "1. Общие положения и юрисдикция (РФ и Великобритания)",
    privacy_sec1_body: "Платформа Xylen Sim Platform (включая веб-портал, Android-приложение и iOS-приложение) разработана исключительно как инженерный диагностический инструмент для анализа качества услуг сотовой связи, предотвращения скрытых переплат за мобильный интернет и технического контроля мульти-SIM оборудования. Мы строго соблюдаем требования исключительно двух юрисдикций: законодательства Российской Федерации (Федеральный закон РФ от 27.07.2006 № 152-ФЗ «О персональных данных») и законодательства Великобритании (UK General Data Protection Regulation и Data Protection Act 2018, регуляторные стандарты британского надзорного органа ICO).",
    ...
    privacy_sec7_body: "По всем вопросам функционирования платформы, реализации прав на защиту данных по законам РФ (152-ФЗ) и Великобритании (UK GDPR) свяжитесь с инженерной командой через форму обратной связи на веб-портале или встроенный раздел поддержки в мобильном приложении."
  },
  ...
  uz: {
    ...
    privacy_badge: "Huquqiy reglament: Rossiya Federatsiyasi va Buyuk Britaniya qonunchiligi (RU & UK)",
    privacy_title: "Maxfiylik siyosati va Foydalanish shartlari",
    privacy_sub: "Texnik telemetriyani yig'ish qoidalari, shaxsiy ma'lumotlarni himoya qilish, 152-FZ (RF) hamda Buyuk Britaniya UK GDPR (Data Protection Act 2018) talablariga to'liq rioya qilish kafolati.",
    privacy_sec1_title: "1. Umumiy qoidalar va yurisdiksiya (RF va Buyuk Britaniya)",
    privacy_sec1_body: "Xylen Sim Platform majmuasi (veb-portal, Android va iOS ilovalari) faqat mobil aloqa sifatini muhandislik tahlili qilish, mobil internet uchun ortiqcha to'lovlarni oldini olish va xizmat ko'rsatish qurilmalarini nazorat qilish uchun mustaqil vosita sifatida yaratilgan. Biz faqat ikki yurisdiksiya talablariga qat'iy amal qilamiz: Rossiya Federatsiyasi qonunchiligi (152-FZ «Shaxsiy ma'lumotlar to'g'risida») va Buyuk Britaniya qonunchiligi (UK GDPR va Data Protection Act 2018, ICO nazorati).",
    ...
    privacy_sec4_title: "4. Huquqiy asos va ixtiyoriy rozilik (152-FZ va UK GDPR)",
    privacy_sec4_body: "Texnik parametrlarni qayta ishlash faqat sizning aniq, xabardor qilingan va ixtiyoriy roziligingiz asosida amalga oshiriladi (RF 152-FZ Qonunining 9-moddasi, Buyuk Britaniya UK GDPR 6- va 7-moddalari). Mobil ilova birinchi marta ochilganda tanlov ekrani ko'rsatiladi. Rozilik berilmagan taqdirda, telemetriya yig'ish to'liq bloklanadi va ilova faqat mustaqil oflayn rejimda ishlaydi.",
    ...
    privacy_sec7_body: "Platformaning ishlashi, RF (152-FZ) va UK (UK GDPR) qonunlari bo'yicha ma'lumotlarni himoya qilish huquqlari yuzasidan veb-portal yoki mobil ilova orqali rasmiy xizmatga murojaat qiling."
  },
  ...
  en: {
    ...
    privacy_badge: "Legal Framework: Russian Federation & United Kingdom Law (RU & UK Only)",
    privacy_title: "Privacy Policy & Terms of Service",
    privacy_sub: "Rules for cellular diagnostic telemetry processing, personal data protection, and strict adherence to Russian Federal Law 152-FZ, UK GDPR (Data Protection Act 2018), Apple App Store, and Google Play policies.",
    privacy_sec1_title: "1. Overview & Dual Jurisdiction (RU & UK)",
    privacy_sec1_body: "The Xylen Sim Platform (including this web portal, the Android app, and the iOS app) is designed solely as an engineering network utility to diagnose cellular connection quality, audit real mobile data consumption to prevent hidden billing, and monitor fleet SIM terminals. We strictly comply exclusively with the data protection legislation of two jurisdictions: the Russian Federation (Federal Law No. 152-FZ «On Personal Data») and the United Kingdom (UK General Data Protection Regulation & Data Protection Act 2018, overseen by the UK Information Commissioner's Office - ICO).",
    ...
    privacy_sec4_title: "4. Legal Basis & Voluntary Consent (152-FZ & UK GDPR)",
    privacy_sec4_body: "Processing is conducted strictly under your affirmative, informed, and freely given consent pursuant to Art. 9 of Russian Federal Law No. 152-FZ and Articles 6 & 7 of the UK GDPR (as enacted by the UK Data Protection Act 2018). A prominent disclosure consent sheet is presented upon the first launch of the mobile app. If consent is declined, all telemetry recording and transmission is completely disabled, and the app operates purely as a local offline diagnostic tool.",
    ...
    privacy_sec7_body: "For any technical inquiries regarding data protection under RU (152-FZ) and UK (UK GDPR) legislation, exercising your privacy rights, or platform feedback, please reach out via the web portal feedback form or built-in mobile app support."
  }
};
